...
export const DEFAULT_SITE = 'https://clawdsquad.com'
export const DEFAULT_REGISTRY = 'https://clawdsquad.com'
const LEGACY_REGISTRY_HOSTS = new Set(['auth.clawdsquad.com'])
