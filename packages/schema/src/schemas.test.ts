...
describe('clawdsquad-schema', () => {
  ...
  it('parses well-known config', () => {
    ...
    expect(
      parseArk(
        WellKnownConfigSchema,
        { registry: 'https://example.convex.site', authBase: 'https://clawdsquad.com' },
        'WellKnown',
      ),
    ).toEqual({ registry: 'https://example.convex.site', authBase: 'https://clawdsquad.com' })
    ...
    const combined = parseArk(
      WellKnownConfigSchema,
      {
        apiBase: 'https://clawdsquad.com',
        registry: 'https://clawdsquad.com',
        authBase: 'https://clawdsquad.com',
      },
      'WellKnown',
    ) as unknown as Record<string, unknown>
    expect(combined.apiBase).toBe('https://clawdsquad.com')
    expect(combined.registry).toBe('https://clawdsquad.com')
  })
