...
import { getClawdSquadSiteUrl, getSiteMode, getSiteName } from '../lib/site'
...
export default function Header() {
  ...
  const moltHubUrl = getClawdSquadSiteUrl()
    ...
    <header className="navbar">
      <div className="navbar-inner">
        ...
        <nav className="nav-links">
          {isSoulMode ? <a href={moltHubUrl}>ClawdSquad</a> : null}
          {isSoulMode ? (
            <Link
              to="/souls"
              search={{
              ...
              <DropdownMenuContent align="end">
                {isSoulMode ? (
                  <DropdownMenuItem asChild>
                    <a href={moltHubUrl}>ClawdSquad</a>
                  </DropdownMenuItem>
                ) : null}
                <DropdownMenuItem asChild>
                  {isSoulMode ? (
