...
describe('theme', () => {
  ...
  it('reads stored theme with fallback', () => {
    ...
    window.localStorage.setItem('clawdsquad-theme', 'dark')
    expect(getStoredTheme()).toBe('dark')
    window.localStorage.setItem('clawdsquad-theme', 'nope')
    expect(getStoredTheme()).toBe('system')
  })
  ...
  it('useThemeMode persists and applies mode', async () => {
    ...
    expect(window.localStorage.getItem('clawdsquad-theme')).toBe('dark')
  })
})
